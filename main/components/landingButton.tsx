  ...
  return (
    <>
      <div className="flex gap-3">
        <button className="w-28 h-12 text-white font-semibold bg-teal-500 rounded-lg shadow-lg hover:scale-105 hover:bg-teal-700 duration-200 hover:drop-shadow-2xl hover:cursor-pointer">
          Click me!
        </button>
